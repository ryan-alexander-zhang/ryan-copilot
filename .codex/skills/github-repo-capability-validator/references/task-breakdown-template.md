...
| T03+ | `NN-capability-<name>.md` | Verify one capability at a time against code | README extraction, shared skeleton | T01, T02 | pending |
...
- Create one capability task per normalized capability.
