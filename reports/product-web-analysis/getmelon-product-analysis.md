...
- 通俗含义：常见的银行账户连接与验证基础设施服务。
- 在本产品中的含义：Melon 条款中提到该类服务商，说明其银行账户连接或验证能力至少部分依赖外部基础设施。
- 类型：关键外部服务商名词。

### Dwolla

- 通俗含义：美国账户间转账与资金流转基础设施服务商。
- 在本产品中的含义：Melon 条款中明确提到 Dwolla Account，说明其部分资金处理能力与 Dwolla 体系相关。
- 类型：关键外部服务商名词。

### Stripe

- 通俗含义：支付、账单和收款能力平台。
- 在本产品中的含义：公开帮助文档与 invoicing 体验线索表明，Melon 的部分收款能力很可能与这类支付基础设施有关。
- 类型：关键外部服务商名词。

### FansMetric

- 通俗含义：面向创作者经营数据和分析的外部平台。
- 在本产品中的含义：Melon 的 automated invoicing 功能要求先连接 FansMetric，再基于外部经营数据生成账单。
- 类型：关键外部平台名词。
